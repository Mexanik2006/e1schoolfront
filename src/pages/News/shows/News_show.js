...
function News_show() {
    ...
    const [newsData, setNewsData] = useState({ title: '', description: '', imgUrl: '', createdAt: '' });
            ...
            if (selectedFile) {
                ...
                uploadTask.on(
                    ...
                    async () => {
                        ...
                        await axios.put(`/addnew/update/${id}`, {
                            ...newsData,
                ...
                await axios.put(`/addnew/update/${id}`, newsData);
                alert("Yangilik muvaffaqiyatli yangilandi");
            }
                ...
                <div className='new_show'>
                    <div className="new_show_change">
                        ...
                        <div className="new_show_conter_update">
                            <label htmlFor="">Yangilik sarlavhasini almashtirish: </label>
                            <input type="text"
                                name="title"
                        ...
                        <div className="new_show_bottom_update">
                            <label htmlFor="">Yangilik kengaytmasini almashtirish: </label>
                    ...
                    <div className="new_show_update">
                        ...
                        <div className="new_show_bottom">
                            <p>{newsDate.description}</p>
                        </div>
                        <div className="news_show_time">

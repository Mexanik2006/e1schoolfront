...
function Teacher() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`/teacher/create`, { ...inputs, teachername });
            ...
            <form onSubmit={handleSubmit}>
                <div className="">
                    <div className="admin_news_title">
                        <h1>Upload Teacher:</h1>
                    </div>
                    <div>
                        <label htmlFor="img" className='label'>Upload teacher's image:</label> {imgPerc > 0 && `Uploading: ${imgPerc}%`}
                        <br />
                        <input
                            type="file"
                            accept="image/*"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                setInputs((prev) => ({ ...prev, teachername: e.target.value })); // Update inputs state
                            }}
                            required
                        />
                    </div>
